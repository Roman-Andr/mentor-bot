...
def upgrade() -> None:
    ...
    sa.Column("status", sa.Enum("DRAFT", "ACTIVE", "ARCHIVED", "DEPRECATED", name="templatestatus"), nullable=False),
    ...
    sa.Column("status", sa.Enum("PENDING", "IN_PROGRESS", "COMPLETED", "BLOCKED", "CANCELLED", name="status"), nullable=False),
    ...
    sa.Column("category", sa.Enum("DOCUMENTATION", "INTRODUCTION", "TECHNICAL", "TRAINING", "MEETING", "PAPERWORK", "SECURITY", "HR", "OTHER", name="taskcategory"), nullable=False),
