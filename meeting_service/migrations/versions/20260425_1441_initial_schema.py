...
def upgrade() -> None:
    ...
    op.create_table("meeting_materials",
    sa.Column("id", sa.Integer(), nullable=False),
    ...
    sa.Column("user_id", sa.Integer(), nullable=False),
    sa.Column("meeting_id", sa.Integer(), nullable=False),
    sa.Column("status", sa.Enum("SCHEDULED", "COMPLETED", "MISSED", "CANCELLED", name="meetingstatus"), nullable=False),
    ...
    op.create_index(op.f("ix_user_meetings_google_calendar_event_id"), "user_meetings", ["google_calendar_event_id"], unique=False)
