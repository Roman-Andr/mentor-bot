...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_scheduled_notifications_processed"), "scheduled_notifications", ["processed"], unique=False
    )
    op.create_index(
        op.f("ix_scheduled_notifications_scheduled_time"), "scheduled_notifications", ["scheduled_time"], unique=False
    )
