...
import httpx
from notification_service.utils.logging import (
    InterceptHandler,
    configure_logging,
    inject_request_id,
    request_id_var,
...
class TestConfigureLogging:
    ...
    def test_configures_intercept_handler(self) -> None:
        ...
        configure_logging("notification_service", "INFO")
    ...
    def test_configure_logging_handles_os_error(self) -> None:
        ...
        from notification_service.utils import logging as logging_module
