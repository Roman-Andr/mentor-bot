...
def upgrade() -> None:
    ...
    sa.Column("source", sa.Enum("MANUAL", "AUTO_OVERDUE", "AUTO_SEARCH_FAILED", "AUTO_NO_ANSWER", name="escalationsource"), nullable=False),
    sa.Column("reason", sa.Text(), nullable=True),
    sa.Column("context", postgresql.JSONB(astext_type=sa.Text()), nullable=False),
    sa.Column("status", sa.Enum("PENDING", "ASSIGNED", "IN_PROGRESS", "RESOLVED", "REJECTED", "CLOSED", name="escalationstatus"), nullable=False),
