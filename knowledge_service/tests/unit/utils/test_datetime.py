...
class TestIsExpired:
    ...
    def test_is_expired_without_threshold_true(self) -> None:
        ...
        past_dt = datetime(2024, 6, 15, 11, 59, 59, tzinfo=UTC)
    ...
    def test_is_expired_with_threshold_true(self) -> None:
        ...
        dt = datetime(2024, 6, 15, 11, 55, 0, tzinfo=UTC)
...
class TestGetExpiryTime:
    ...
    def test_get_expiry_time_days(self) -> None:
        ...
        result = get_expiry_time(days=7)
        assert result == datetime(2024, 6, 22, 12, 0, 0, tzinfo=UTC)

    @freeze_time("2024-06-15 12:00:00")
    def test_get_expiry_time_hours(self) -> None:
        """get_expiry_time() adds hours correctly."""
        result = get_expiry_time(hours=5)
        assert result == datetime(2024, 6, 15, 17, 0, 0, tzinfo=UTC)
    ...
    def test_get_expiry_time_combined(self) -> None:
        ...
        assert result == datetime(2024, 6, 16, 14, 30, 0, tzinfo=UTC)
