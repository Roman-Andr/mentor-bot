...
from feedback_service.api.endpoints import audit_router, feedback_router, internal_router
...
configure_logging(service_name="feedback_service", log_level=settings.LOG_LEVEL)
...
app.include_router(internal_router, prefix=f"{settings.API_V1_PREFIX}/feedback/internal", tags=["internal"])
