...
def mock_uow():
    ...
    uow.login_history.delete_by_user_id = AsyncMock()
    uow.logout_history = MagicMock()
    uow.logout_history.create = AsyncMock()
    uow.logout_history.delete_by_user_id = AsyncMock()
    uow.invitation_status_history = MagicMock()
    uow.invitation_status_history.create = AsyncMock()
    uow.invitation_status_history.nullify_changed_by = AsyncMock()
    uow.mentor_assignment_history = MagicMock()
    uow.mentor_assignment_history.create = AsyncMock()
    uow.mentor_assignment_history.delete_by_user_id = AsyncMock()
    uow.mentor_assignment_history.delete_by_mentor_id = AsyncMock()
    uow.mentor_assignment_history.nullify_changed_by = AsyncMock()
    uow.password_change_history = MagicMock()
    uow.password_change_history.create = AsyncMock()
    uow.password_change_history.delete_by_user_id = AsyncMock()
    uow.password_change_history.nullify_changed_by = AsyncMock()
    uow.role_change_history = MagicMock()
    uow.role_change_history.create = AsyncMock()
    uow.role_change_history.delete_by_user_id = AsyncMock()
    uow.role_change_history.nullify_changed_by = AsyncMock()
    uow.password_reset = MagicMock()
    uow.password_reset.delete_by_user_id = AsyncMock()
    uow.invitations.nullify_user_id = AsyncMock()
    uow.invitations.nullify_mentor_id = AsyncMock()
