"""Checklist detail and task action keyboards."""
...
def get_no_checklists_keyboard(*, locale: str = "en") -> InlineKeyboardBuilder:
    """Build keyboard shown when user has no checklists."""
...
def get_no_tasks_keyboard(*, locale: str = "en") -> InlineKeyboardBuilder:
    """Build keyboard shown when a checklist has no tasks."""
    builder = InlineKeyboardBuilder()
    builder.add(
...
def get_attach_task_keyboard(
    ...
    """Build keyboard for attaching a file to a task."""
    builder = InlineKeyboardBuilder()
    builder.add(
        create_inline_button(
...
def get_task_info_keyboard(
    ...
    builder.add(
        ...
        create_inline_button(
            f"\u2190 {t('common.back_button', locale=locale)}", callback_data="my_tasks"
        ),
    )
    builder.adjust(1)
    return builder
...
def get_task_completed_keyboard(
    ...
    """Build keyboard shown after task completion."""
    builder = InlineKeyboardBuilder()
    builder.add(
        create_inline_button(
            "\u2705 Completed",
