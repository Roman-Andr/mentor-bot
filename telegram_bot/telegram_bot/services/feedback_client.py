...
class FeedbackServiceClient:
    ...
    async def submit_pulse_survey(self, user_id: int, rating: int, auth_token: str) -> bool:
    ...
    async def submit_experience_rating(self, user_id: int, rating: int, auth_token: str) -> bool:
