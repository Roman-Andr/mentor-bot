...
describe("usePreferences", () => {
  ...
  it("optimistically updates cached preferences and rolls back on failure", async () => {
    const initialPreferences = {
      language: "en",
      notification_telegram_enabled: true,
      notification_email_enabled: true,
    ...
    vi.mocked(usersApi.getMyPreferences).mockResolvedValue(initialPreferences as any);
    vi.mocked(usersApi.updateMyPreferences).mockRejectedValue(new Error("Update failed"));
    ...
    queryClient.setQueryData(["preferences"], initialPreferences);
    ...
    expect(queryClient.getQueryData(["preferences"])).toEqual(initialPreferences);
  });
