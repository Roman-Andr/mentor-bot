...
describe("queryKeys", () => {
  ...
  it("notifications.list returns correct key", () => {
    expect(queryKeys.notifications.list({ page: 1 })).toEqual([
      "notifications",
      "list",
      { page: 1 },
    ]);
  ...
  it("notificationTemplates.list returns correct key", () => {
    expect(queryKeys.notificationTemplates.list({ page: 1 })).toEqual([
  ...
  it("notificationTemplates.list without params returns correct key", () => {
    expect(queryKeys.notificationTemplates.list()).toEqual([
      "notification-templates",
      "list",
      undefined,
    ]);
  ...
  it("notificationTemplates.detail returns correct key", () => {
    expect(queryKeys.notificationTemplates.detail(123)).toEqual([
      "notification-templates",
      "detail",
      123,
    ]);
  ...
  it("analytics.knowledge.summary returns correct key", () => {
    expect(queryKeys.analytics.knowledge.summary({ from_date: "2024-01-01" })).toEqual([
      "analytics",
      "knowledge",
      "summary",
  ...
  it("analytics.knowledge.summary without params returns correct key", () => {
    expect(queryKeys.analytics.knowledge.summary()).toEqual([
      "analytics",
      "knowledge",
      "summary",
      undefined,
  ...
  it("analytics.knowledge.topArticles returns correct key", () => {
    expect(queryKeys.analytics.knowledge.topArticles({ limit: 10 })).toEqual([
      "analytics",
      "knowledge",
      "top-articles",
      { limit: 10 },
  ...
  it("analytics.knowledge.timeseries returns correct key", () => {
    expect(queryKeys.analytics.knowledge.timeseries({ granularity: "day" })).toEqual([
      "analytics",
      "knowledge",
      "timeseries",
      { granularity: "day" },
  ...
  it("analytics.knowledge.byCategory returns correct key", () => {
    expect(queryKeys.analytics.knowledge.byCategory({ from_date: "2024-01-01" })).toEqual([
      "analytics",
      "knowledge",
      "by-category",
      { from_date: "2024-01-01" },
  ...
  it("analytics.knowledge.byTag returns correct key", () => {
    expect(queryKeys.analytics.knowledge.byTag({ from_date: "2024-01-01" })).toEqual([
      "analytics",
      "knowledge",
      "by-tag",
      { from_date: "2024-01-01" },
  ...
  it("analytics.history.feed returns correct key", () => {
    expect(queryKeys.analytics.history.feed({ page: 1, page_size: 10 })).toEqual([
      "analytics",
      "history",
      "feed",
      { page: 1, page_size: 10 },
  ...
  it("feedback.pulseAnonymityStats returns correct key", () => {
    expect(queryKeys.feedback.pulseAnonymityStats()).toEqual([
      "feedback",
      "pulse",
      "anonymity-stats",
    ]);
  ...
  it("feedback.experience returns correct key", () => {
    expect(queryKeys.feedback.experience({ page: 1 })).toEqual([
      "feedback",
      "experience",
      { page: 1 },
    ]);
  ...
  it("feedback.experienceAnonymityStats returns correct key", () => {
    expect(queryKeys.feedback.experienceAnonymityStats()).toEqual([
      "feedback",
      "experience",
      "anonymity-stats",
    ]);
  ...
  it("feedback.commentAnonymityStats returns correct key", () => {
    expect(queryKeys.feedback.commentAnonymityStats()).toEqual([
      "feedback",
      "comments",
      "anonymity-stats",
    ]);
