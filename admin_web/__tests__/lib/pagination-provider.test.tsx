...
import { PaginationProvider, PaginationContext, usePaginationSettings } from '@/shared/providers/pagination-provider'
...
describe('PaginationProvider', () => {
  ...
  it('renders children', () => {
    render(<PaginationProvider><div data-testid="child">child</div></PaginationProvider>)
