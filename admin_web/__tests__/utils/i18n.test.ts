...
describe('i18n locale completeness', () => {
  ...
  it('both locales have required top-level namespaces', () => {
    const requiredNamespaces = [
      'common', 'analytics', 'auth', 'checklists', 'dashboard',
      'departments', 'dialogues', 'escalations', 'feedback', 'invitations',
      'knowledge', 'meetings', 'nav', 'notificationTemplates', 'pagination',
      'settings', 'statuses', 'templates', 'users',
    ]
