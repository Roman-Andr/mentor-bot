...
describe("fetchApi", () => {
  ...
  it("handles 401 unauthorized before a callback is registered", async () => {
...
describe("analyticsApi.search", () => {
  ...
  it("calls timeseries endpoint with day granularity", async () => {
    mockFetchResponse([{ bucket: "2024-01-01T00:00:00Z", search_count: 50, unique_users: 10 }]);
  ...
  it("calls timeseries endpoint with week granularity", async () => {
    mockFetchResponse([{ bucket: "2024-01-01T00:00:00Z", search_count: 400, unique_users: 100 }]);
