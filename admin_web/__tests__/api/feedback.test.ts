...
describe("feedbackApi", () => {
  describe("Pulse surveys", () => {
    ...
    it("deletePulseSurvey calls fetchApi with DELETE", () => {
      feedbackApi.deletePulseSurvey(123);
      expect(mockFetchApi).toHaveBeenCalled();
    });
  });
  ...
  describe("Experience ratings", () => {
    ...
    it("deleteExperienceRating calls fetchApi with DELETE", () => {
      feedbackApi.deleteExperienceRating(456);
      expect(mockFetchApi).toHaveBeenCalled();
    });
  });
  ...
  describe("Comments", () => {
    ...
    it("deleteComment calls fetchApi with DELETE", () => {
      feedbackApi.deleteComment(789);
      expect(mockFetchApi).toHaveBeenCalled();
    });
  });
