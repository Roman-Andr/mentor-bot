...
import { useDialogueEdit } from "@/shared/hooks/use-dialogue-edit";
import { useConfirm } from "@/shared/hooks/use-confirm";
import { StepFormDialog } from "@/widgets/dialogues/step-form-dialog";
import { DialogueEditHeader, DialogueMetadataForm, DialogueStepsTable } from "@/widgets/dialogues";
import type { DialogueStep, DialogueCategory } from "@/shared/types";
...
export function DialogueEditWidget({ params }: Props) {
  const { id } = use(params);
