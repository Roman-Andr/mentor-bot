...
import { UserFormDialog } from "@/widgets/users/user-form-dialog";
import { UsersTable } from "@/widgets/users/users-table";
import { AssignMentorDialog } from "@/widgets/users/assign-mentor-dialog";
import type { UserFormData } from "@/shared/hooks/use-users";
import type { UserItem } from "@/shared/hooks/use-users";
import type { Department } from "@/shared/types/department";
import type { UserMentor } from "@/shared/types/user";
...
interface UsersSectionProps {
  ...
  handleDeactivateUser?: (user: UserItem) => Promise<void>;
